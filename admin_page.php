...
if(isset($_POST['add_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_image)){
      ...
      if($upload){
         ...
         $message[] = 'Produk Baru Telah Di Tambahkan!';
      }else{
...
<div class="container">
   ...
   <div class="admin-product-form-container">
      ...
      <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
         ...
         <input type="text" placeholder="Nama Produk" name="product_name" class="box">
         <input type="number" placeholder="Harga Produk" name="product_price" class="box">
